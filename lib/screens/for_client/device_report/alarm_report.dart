...
class AlarmReport extends StatefulWidget {
  const AlarmReport(this.s, String a, {Key? key}) : super(key: key);
  final String s;
  @override
  State<AlarmReport> createState() => _AlarmReportState();
}

class _AlarmReportState extends State<AlarmReport> {
  ...
  void initState() {
    ...
    deviceName = TextEditingController(text: 'Alarm');
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Center(
                          child:
                              Text('What alarm issue would you like to report?',
