...
class BASReport extends StatefulWidget {
  const BASReport(this.s, String a, {Key? key}) : super(key: key);
  final String s;
  @override
  State<BASReport> createState() => _BASReportState();
}

class _BASReportState extends State<BASReport> {
  ...
  void initState() {
    ...
    deviceName = TextEditingController(text: 'BAS');
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Center(
                          child:
                              Text('What BAS issue would you like to report?',
                              ...
                              children: [
                                CheckboxGroup(
                                  labels: const <String>[
                                    ...
                                    'Sensor/Field device malfunctions',
