...
class CCTVReport extends StatefulWidget {
  const CCTVReport(this.s, String a, {Key? key}) : super(key: key);
  final String s;
  @override
  State<CCTVReport> createState() => _CCTVReportState();
}

class _CCTVReportState extends State<CCTVReport> {
  ...
  void initState() {
    ...
    deviceName = TextEditingController(text: 'CCTV');
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Center(
                          child:
                              Text('What CCTV issue would you like to report?',
                        ...
                        child: Container(
                            ...
                            child: ListView(
                              ...
                              children: [
                                CheckboxGroup(
                                  labels: const <String>[
                                    'Camera cannot display image',
                                    'Camera image is blurry',
                                    'DVD no recording/Playback malfunction',
                                    'Monitor/TV malfunction',
                                    'Others'
                                  ],
