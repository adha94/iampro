...
class PMSReport extends StatefulWidget {
  const PMSReport(this.s, String a, {Key? key}) : super(key: key);
  final String s;
  @override
  State<PMSReport> createState() => _PMSReportState();
}

class _PMSReportState extends State<PMSReport> {
  ...
  void initState() {
    ...
    deviceName = TextEditingController(text: 'PMS');
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Center(
                          child:
                              Text('What PMS issue would you like to report?',
                        ...
                        child: Container(
                            ...
                            child: ListView(
                              ...
                              children: [
                                CheckboxGroup(
                                  labels: const <String>[
                                    'Barrier gate malfunctions',
                                    'Barrier gate push button malfunctions',
                                    'Card access malfunctions',
                                    'Others'
                                  ],
