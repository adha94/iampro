...
class PABXReport extends StatefulWidget {
  const PABXReport(this.s, String a, {Key? key}) : super(key: key);
  final String s;
  @override
  State<PABXReport> createState() => _PABXReportState();
}

class _PABXReportState extends State<PABXReport> {
  ...
  void initState() {
    ...
    deviceName = TextEditingController(text: 'PABX');
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Center(
                          child:
                              Text('What PABX issue would you like to report?',
                        ...
                        child: Container(
                            ...
                            child: ListView(
                              ...
                              children: [
                                CheckboxGroup(
                                  labels: const <String>[
                                    'Keyphone malfunctions',
                                    'No dial tone',
                                    'Faulty intercom call',
                                    'Workstation/Software malfunctions',
                                    'Others'
                                  ],
