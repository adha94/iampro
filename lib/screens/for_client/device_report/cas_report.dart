...
class CASReport extends StatefulWidget {
  const CASReport(this.s, String a, {Key? key}) : super(key: key);
  final String s;
  @override
  State<CASReport> createState() => _CASReportState();
}

class _CASReportState extends State<CASReport> {
  ...
  void initState() {
    ...
    deviceName = TextEditingController(text: 'CAS');
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Center(
                          child:
                              Text('What CAS issue would you like to report?',
                        ...
                        child: Container(
                            ...
                            child: ListView(
                              ...
                              children: [
                                CheckboxGroup(
                                  labels: const <String>[
                                    'Door cannot lock/release',
                                    'In/out reader function',
                                    'Workstation/Software malfunction',
                                    'Others'
                                  ],
