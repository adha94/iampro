...
class SMATVReport extends StatefulWidget {
  const SMATVReport(this.s, String a, {Key? key}) : super(key: key);
  final String s;
  @override
  State<SMATVReport> createState() => _SMATVReportState();
}

class _SMATVReportState extends State<SMATVReport> {
  ...
  void initState() {
    ...
    deviceName = TextEditingController(text: 'Smart TV');
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Center(
                          child: Text(
                              'What Smart TV issue would you like to report?',
