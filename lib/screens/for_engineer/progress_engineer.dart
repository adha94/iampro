...
import 'package:iampro_client/screens/for_engineer/progress_details_engineer.dart';
import 'package:iampro_client/screens/login.dart';
import 'package:percent_indicator/percent_indicator.dart';

class ProgressEngineer extends StatefulWidget {
  const ProgressEngineer({Key? key, required String title}) : super(key: key);

  @override
  State<ProgressEngineer> createState() => _ProgressEngineerState();
}

class _ProgressEngineerState extends State<ProgressEngineer> {
  @override
  void initState() {
    super.initState();
  }
