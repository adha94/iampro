...
class NotificationsEngineerCompleted extends StatelessWidget {
  const NotificationsEngineerCompleted(this.firestoreDocID, {Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text(
          'Notifications Details - Completed',
          style: TextStyle(
