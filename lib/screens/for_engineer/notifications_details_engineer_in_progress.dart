...
class NotificationsEngineerInProgress extends StatefulWidget {
  const NotificationsEngineerInProgress(this.firestoreDocID, {Key? key})
      : super(key: key);
  final int firestoreDocID;

  @override
  State<NotificationsEngineerInProgress> createState() =>
      _NotificationsEngineerInProgressState();
}

class _NotificationsEngineerInProgressState
    extends State<NotificationsEngineerInProgress> {
  DocumentSnapshot? ds;
  File? image;
  firebase_storage.UploadTask? uploadTask;
  firebase_storage.FirebaseStorage storage =
      firebase_storage.FirebaseStorage.instance;
  TextEditingController engineerComments = TextEditingController();
                    ...
                    return Column(children: [
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            uploadFile(image!, engineerComments.text);
  ...
  Future uploadFile(File? image, String? engineerKomen) async {
    if (image == null) return;
    ...
    try {
      ...
      await referReportID.update({
        ...
        'report_status': 'Awaiting Confirmation'
      }).then((value) {
        try {
