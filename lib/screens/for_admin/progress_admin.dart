...
import 'package:iampro_client/screens/for_admin/progress_details_admin.dart';
import 'package:iampro_client/screens/login.dart';
import 'package:percent_indicator/percent_indicator.dart';

class ProgressAdmin extends StatefulWidget {
  const ProgressAdmin({Key? key}) : super(key: key);

  @override
  State<ProgressAdmin> createState() => _ProgressAdminState();
}

class _ProgressAdminState extends State<ProgressAdmin> {
  @override
