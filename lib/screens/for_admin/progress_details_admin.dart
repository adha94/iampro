...
class ProgressDetailsAdmin extends StatelessWidget {
  const ProgressDetailsAdmin(this.firestoreDocID, {Key? key}) : super(key: key);
                                ...
                                children: [
                                  ...
                                  Row(children: [
                                    CircleAvatar(
                                      ...
                                      backgroundImage: ds['company_logo'] !=
                                              null
                              ...
                              onPressed: () => showDialog(
                                  ...
                                  builder: (context) {
                                    return AlertDialog(
                                      ...
                                      content:
                                          const Text('Proceed with deletion?'),
                                      actions: [
                                        TextButton(
                                            onPressed: () async {
